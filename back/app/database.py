...
from app.config import MONGODB_URI, MONGODB_IDENTITY_DB, MONGODB_MEDICAL_DB
...
def init_database():
    ...
    try:
        ...
        identity_db.audit_log.create_index([("created_at", -1)])
        identity_db.audit_log.create_index([("event_type", 1), ("created_at", -1)])
        identity_db.audit_log.create_index([("actor_user_id_auth", 1), ("created_at", -1)])
        identity_db.audit_log.create_index([("resource_type", 1), ("resource_id", 1), ("created_at", -1)])
        identity_db.users.create_index("patient_pseudo_id", unique=True, sparse=True)
        ...
        medical_db.measurements.create_index("patient_pseudo_id", sparse=True)
        ...
        medical_db.alerts.create_index("patient_pseudo_id", sparse=True)
        ...
        medical_db.alerts.create_index("severity_level")
        ...
        try:
            from app.services.ml_thresholds_store import load_ml_thresholds_from_db
