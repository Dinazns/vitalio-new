...
from app.services.measurement_service import validate_measurement_payload_mqtt
from app.services.alert_service import evaluate_measurement_alerts
...
def on_mqtt_message(client, userdata, msg):
    ...
    try:
        ...
        attach_patient_pseudo_to_doc(measurement_doc, device_id=device_id)
